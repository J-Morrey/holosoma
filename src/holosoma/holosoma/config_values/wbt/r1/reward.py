...
r1_26dof_wbt_reward = RewardManagerCfg(
    terms={
        ...
        "undesired_contacts": RewardTermCfg(
            ...
            params={
                "threshold": 1.0,
                # R1 has no dedicated foot-contact-point bodies like G1; the terminal ankle_roll
                # links themselves are the foot, and wrist_roll is the terminal arm link (no
                # separate hand), so those are the bodies excluded from the "undesired contact"
                # penalty (ground/incidental contact there is expected).
...
r1_26dof_wbt_fast_sac_reward = RewardManagerCfg(
    terms={
        **r1_26dof_wbt_reward.terms,
        "action_rate_l2": RewardTermCfg(
            func="holosoma.managers.reward.terms.wbt:penalty_action_rate",
            weight=-1.0,
        ),
...
__all__ = ["r1_26dof_wbt_reward", "r1_26dof_wbt_fast_sac_reward"]
